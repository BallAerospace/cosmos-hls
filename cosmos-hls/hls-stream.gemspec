...
spec = Gem::Specification.new do |s|
  s.name = 'cosmos-hls-stream'
  s.summary = 'Ball Aerospace COSMOS'
  s.description =  <<-EOF
    This plugin encodes a video to an HLS stream in Redis and Minio
    to be used with the VideoPlayer tool.
  EOF
  s.authors = ['Ryan Pratt']
  s.email = ['ryan.pratt@ballaerospace.com']
  s.homepage = 'https://github.com/BallAerospace/cosmos-hls'
  ...
  s.files = ['transcoder.rb', 'plugin.txt']
